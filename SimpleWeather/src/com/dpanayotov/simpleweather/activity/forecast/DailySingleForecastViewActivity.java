...
public class DailySingleForecastViewActivity extends BaseSWActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		forecasts = mForecastResponse.getDaily().getData();
	...
	private class SingleItemForecastPagerAdapter extends
		...
		public Fragment getItem(int position) {
			DailySingleItemForecastFragment fragment = new DailySingleItemForecastFragment();
		...
		public CharSequence getPageTitle(int position) {
			return DateUtil.getFormatedDate(forecasts.get(position).getTime(),
					DateUtil.FORECAST_SINGLE_ITEM_FORMAT_DAILY);
		}
	}
